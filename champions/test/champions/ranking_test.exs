defmodule Champions.RankingTest do
  ...
  describe "change_user_points/2" do
    test "accepts non-negative integers" do
      assert %Ecto.Changeset{} =
               changeset = Ranking.change_user_points(%User{}, %{"points" => -1})
      ...
      assert %Ecto.Changeset{} =
               changeset = Ranking.change_user_points(%User{}, %{"points" => 10})
  ...
  describe "declare_draw_match/2" do
    test "adds 1 point to each user" do
      ...
      assert {:ok, %User{points: 1}, %User{points: 1}} =
               Ranking.declare_draw_match(user_a, user_b)
